...
//        }
	...
	if (self.ladder_time < time)
	{
		...
		r = floor(random()*4);
		if (r == 0)
			sound (self, CHAN_VOICE, "player/foot/ladder1.wav", 1, ATTN_NORM);
		else if (r == 1)
			sound (self, CHAN_VOICE, "player/foot/ladder2.wav", 1, ATTN_NORM);
        else if (r == 2)
			sound (self, CHAN_VOICE, "player/foot/ladder3.wav", 1, ATTN_NORM);
		else if (r == 3)
            sound (self, CHAN_VOICE, "player/foot/ladder4.wav", 1, ATTN_NORM);
        sound_on = 0;
	}
