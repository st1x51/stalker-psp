...
#define svc_fog				40		// [byte] start [byte] end [byte] red [byte] green [byte] blue [float] time
#define	svc_showlmp		    41	// [string] slotname [string] lmpfilename [coord] x [coord] y
#define	svc_hidelmp		    42	// [string] slotname
#define	svc_showstring		43	
#define	svc_hidestring		44	
