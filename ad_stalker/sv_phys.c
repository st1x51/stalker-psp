...
// retry the original move
		...
		#ifdef PSP_VFPU
		if ( vfpu_fabsf(oldorg[1] - ent->v.origin[1]) > 4
		|| vfpu_fabsf(oldorg[0] - ent->v.origin[0]) > 4 )
		#else
...
// in the clipping hulls
	...
	{
		#ifdef PSP_VFPU
		if ( vfpu_fabsf(oldorg[1] - ent->v.origin[1]) < 0.03125
		&& vfpu_fabsf(oldorg[0] - ent->v.origin[0]) < 0.03125 )
		#else
